...
export abstract class AbstractFirestoreService {
  abstract get$<T extends { id: string }>(
    key: string,
    id: string,
  ...
  abstract addToArrayField$(key: string, id: string, field: string, item: any): Observable<void>;
  abstract removeFromArrayField$(key: string, id: string, field: string, item: any): Observable<void>;
}
